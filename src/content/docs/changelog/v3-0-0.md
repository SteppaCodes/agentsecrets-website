...
* *Read more in [Agent Capabilities](/docs/proxy/agent-capabilities).*
...
* *Read more in [SSRF Protection](/docs/proxy/ssrf-protection) and [Session Token](/docs/proxy/ssrf-protection).*
...
* *Read more in [env command documentation](/docs/cli/env).*
