...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'agent identity for AI',
    'cryptographic agent token',
    'agent credential binding',
    'secret policy engine',
    'credential domain constraints',
    'process identity verification',
    'anti-impersonation secrets',
    'binary hash verification',
    'keychain auth daemon',
    'zero-knowledge MCP server',
    'MCP credential proxy',
    'AI agent capability policy',
    'credential brokering for agents',
    'secrets policy enforcement',
    'agent-scoped credentials',
    'runtime approval secrets',
    'secret rotation for AI agents',
